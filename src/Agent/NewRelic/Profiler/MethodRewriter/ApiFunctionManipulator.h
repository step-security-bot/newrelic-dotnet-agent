        ...
        void BuildApiInstructions()
        {
            ...
            TryCatch(
                [&]()
                {
                    ...
                    // TODO: control this via configuration option?
                    ...
                    LoadMethodInfo(_instrumentationSettings->GetCorePath(), _X("NewRelic.Agent.Core.AgentApi"), _function->GetFunctionName(), _function->GetFunctionId(), GetArrayOfTypeParametersLamdba(), false);
