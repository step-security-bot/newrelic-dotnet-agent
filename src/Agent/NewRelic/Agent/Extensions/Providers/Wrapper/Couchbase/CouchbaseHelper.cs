        ...
        public static string GetStatement(object parm, string parameterTypeName)
        {
            ...
            switch (parameterTypeName)
            {
                case ("Couchbase.N1QL.IQueryRequest"):
                    {
                        var statementGetter = _getStatement ?? (_getStatement = VisibilityBypasser.Instance.GeneratePropertyReadAccessor<string>("Couchbase.NetClient", "Couchbase.N1QL.QueryRequest", "_statement"));
